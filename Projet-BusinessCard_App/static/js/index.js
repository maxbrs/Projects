...
var ColorBar = React.createClass({ displayName: 'ColorBar',
...
var CardFront = React.createClass({ displayName: 'CardFront',
  render: function render() {
    ...
    return (
      React.createElement('div', { className: 'card-face front', style: { zIndex: zIndex } },
        React.createElement('div', { className: 'title' }, 'Maxime Briens',

          React.createElement('hr', null)),

        React.createElement('div', { className: 'scroll', style: scrollStyle }, '(scroll)'),
...
var CardBack = React.createClass({ displayName: 'CardBack',
  render: function render() {
    ...
    if (!zIndex) return null;
    return (
      React.createElement('div', { className: 'card-face back', style: style },
...
var CardPlane = React.createClass({ displayName: 'CardPlane',
  ...
  render: function render() {
    ...
    var zBack = !zFront;
    return (
      React.createElement('div', { style: this.getStyle(), className: 'card-plane' },
...
var Arrow = React.createClass({ displayName: 'Arrow',
  render: function render() {
    ...
    return (
      React.createElement('div', { className: 'arrow', style: style }, '\u2193'));
  } });


var Line = function Line(_ref) {var children = _ref.children,x = _ref.x,show = _ref.show;return (
...
var Slash = function Slash(props) {return React.createElement('span', null, ' / ');};

var A = function A(_ref2) {var children = _ref2.children,href = _ref2.href;return React.createElement('a', { href: href, target: '_blank' },
    children);};


var BackText = function BackText(_ref3) {var x = _ref3.x;
  ...
  var textShadow = '\n    rgba(0,0,0,' +
  shaddowOpacity + ') 0.5vmin 0 0,\n    rgba(0,0,0,' +
  shaddowOpacity + ') 0.5vmin 0.5vmin 0,\n    rgba(0,0,0,' +
  shaddowOpacity + ') 0.5vmin -0.5vmin 0,\n    rgba(0,0,0,' +
  shaddowOpacity + ') -0.5vmin 0 0,\n    rgba(0,0,0,' +
  shaddowOpacity + ') -0.5vmin 0.5vmin 0,    \n    rgba(0,0,0,' +
  shaddowOpacity + ') -0.5vmin -0.5vmin 0\n  ';
  ...
  return (
    React.createElement('div', { id: 'links', style: style },
      React.createElement(Line, { x: x, show: 0.75 }, 'Maxime Briens'),
      React.createElement(Line, { x: x, show: 0.81 }, 'junior datascientist'),
      React.createElement(Line, { x: x, show: 0.84 }, 'in Oslo, Norway'),

      React.createElement(Line, { x: x, show: 0.87 },
        React.createElement(A)),

        React.createElement(Line, { x: x, show: 0.87 },
        React.createElement(A, { href: '/about' }, 'about'),
        React.createElement(Slash, null),
        React.createElement(A, { href: 'https://memory.ai/en' }, 'dayjob')),

      React.createElement(Line, { x: x, show: 0.90 },
        React.createElement(A, { href: '/resume' }, 'resume'),
        React.createElement(Slash, null),
        React.createElement(A, { href: 'https://linkedin.com/in/maxime-briens/' }, 'linkedin')),

      React.createElement(Line, { x: x, show: 0.93 },
        React.createElement(A, { href: 'https://github.com/maxbrs' }, 'github'),
        React.createElement(Slash, null),
        React.createElement(A, { href: 'https://www.kaggle.com/maxbrs/' }, 'kaggle')),

      React.createElement(Line, { x: x, show: 0.96 },
          React.createElement(A, { href: 'https://maxbrs.shinyapps.io/firstapp/' }, 'website'),
          React.createElement(Slash, null),
          React.createElement(A, { href: 'https://www.instagram.com/maxbriens' }, 'instagram'))));
};
...
var App = React.createClass({ displayName: 'App',
  ...
  handleScroll: function handleScroll(e) {
    var x = fx.limitUnit(window.scrollY / (
  ...
  handleLegacyScroll: function handleLegacyScroll(e) {var _this = this;
  ...
  componentDidMount: function componentDidMount() {
    ...
    var handler = fx.isMobile() && !fx.isSafari() ?
  ...
  render: function render() {
    ...
    return (
      React.createElement('div', { className: 'app', style: this.appStyle },
